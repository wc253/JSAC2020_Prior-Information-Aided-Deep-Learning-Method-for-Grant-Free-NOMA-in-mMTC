...
prob = problems.bernoulli_gaussian_trial(M=240,N=500,L=1000,pnz=.2,pri=.5,SNR=20) #a Bernoulli-Gaussian x, noisily observed through a random matrix
...
layers = networks.build_MPIAN(prob,T=20,initial_lambda=.1,untied=False)
